...
class DuoAthenticationPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('Duo Athentication');
    }
    ...
    {
        return Craft::t('Integrate Duo Security Two-Factor authentication protocols into your Craft installation.');
    }
    ...
    {
       return craft()->templates->render('duoathentication/DuoAthentication_Settings', array(
